classdef FullRandomAlfaGen < BWGraph.RandomGenerator.IRandomGen
    ...
    methods
        function obj = FullRandomAlfaGen(minVal, maxVal)
    ...
    methods (Static)
        function obj = createFromData(data)
            ...
            obj = AlphaGenerator(data.MinValue, data.MaxValue);
        end
    end
end
