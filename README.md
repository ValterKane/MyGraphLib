...
Сигнатура:
```matlab
function Compute_V5(obj, XData, YData, Beta1, Beta2, Eps, NodesWeights, NodesLRScale, ClipUp, ClipDown, Lambda, lambda_Agg, targetWhiteIndices,lossFunction)
```
### Параметры
...
| **`lossFunction`**| `string`| Разновидность целевой функции для расчета ошибок в белых вершинах. Доступные целевые функции: 'mae', 'mse', 'rmse' |
