...
betaGen = FullRandomBetaGen(0,0.1); % Гиперпараметр
...
for i = 1:numSamples
    ...
    TavgValues(i) = HeatBC.CalcCoreFunction(inputParams_for_v1) + ...
        ...
        0.2 * HeatBC.CalcCoreFunction(inputParams_for_v4);
    
end

XData_for_bagging = [timeValues_for_v1, timeValues_for_v2, timeValues_for_v3, ... 
        timeValues_for_v4, TinfValues_for_v1,TinfValues_for_v2,TinfValues_for_v3, TinfValues_for_v4];
...
rng(1111);
% Генерация данных
timeRange_for_v1 = [1000, 15000];
TinfRange_for_v1 = [800, 1300];

timeRange_for_v2 = [1000, 10000];
TinfRange_for_v2 = [800, 1150];  

timeRange_for_v3 = [1000, 9000];
TinfRange_for_v3 = [900, 1150];  

timeRange_for_v4 = [1000, 12000];
TinfRange_for_v4 = [900, 950];  
...
timeValues_for_v4 = rand(validSamples, 1) * (timeRange_for_v4(2) - timeRange_for_v4(1)) + timeRange_for_v4(1);
TinfValues_for_v4 = rand(validSamples, 1) * (TinfRange_for_v4(2) - TinfRange_for_v4(1)) + TinfRange_for_v4(1);
...
XValidData = [timeValues_for_v1, timeValues_for_v2, timeValues_for_v3, timeValues_for_v4 ...
        TinfValues_for_v1,TinfValues_for_v2,TinfValues_for_v3, TinfValues_for_v4];
...
for i = 1:validSamples
    ...
    XDataValid(i) = XDataValid(i).addRow(inputParams_for_v4);
end
